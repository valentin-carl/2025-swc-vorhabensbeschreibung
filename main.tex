...
\begin{center}
    ...
    \begin{tabular}{|l|l|}
        ...
        \begin{tabular}[c]{@{}l@{}}
            \textbf{Applicant} \\
            \needcheck{(Projektrahmenvorhaben)}
        \end{tabular} &
...
\input{sections/2_standWiss.tex}
\input{sections/3_partner.tex}
\input{sections/4_arbeitsplan.tex}
\input{sections/4.3_finanzen.tex}
\input{sections/5_verwertungsplan.tex}
\input{sections/6_literatur.tex}

\appendix

\input{sections/7_anhang.tex}
