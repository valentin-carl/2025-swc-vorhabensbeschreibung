...
\begin{figure}[!h]
    ...
    \caption{
        ...
        \needcheck{The overview does not include the project lead, as it is not financed through Software Campus.}
    }
\end{figure}
...
\needcheck{
An overview of the financial planning can be found in Table 4.2. Only the financial items
Personnel (Section 4.3.1) and Business trips (Section 4.3.2) are available. No external contracts for research and development are planned. A total amount of 110,926.00= C is requested.
}

\textcolor{red}{Muss das mit der Zulage hier noch irgendwie erwähnt werden?}
